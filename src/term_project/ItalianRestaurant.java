...
public class ItalianRestaurant extends Main_Page {

    // Define a menu for the restaurant, with items and their corresponding prices
    private static final String[] MENU_ITEMS = {"Pizza", "Pasta", "Lasagna", "Risotto", "Tiramisu"};
    private static final double[] MENU_PRICES = {10.99, 12.99, 14.99, 11.99, 8.99};
